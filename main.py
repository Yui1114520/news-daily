...
DOMAINS = [
    ...
    {"id":"tech",            "name":"科创",    "icon":"🔬","color":"#00838f",
     "keywords":["technology","ai","artificial intelligence","chip","semiconductor","space","satellite","innovation","tech","cyber","digital","science","research","biotech","biomedical","new energy","quantum","5g","6g","battery","lithium","rare earth","tech sanction","tech blockade","chip ban","export control","supply chain transfer","decoupling","tech war","internet regulation","digital governance","algorithm","large language model","llm","gpt","robot","robotics","automation","self-driving","autonomous vehicle","electric vehicle","ev","green tech","fusion","nuclear fusion","superconductor","photonics","gene editing","crispr","vaccine","drug development","clinical trial","mars","moon mission","iss","rocket","spacecraft","reusable rocket","deep tech","hard tech","deepseek","openai","nvidia","tsmc","asml","huawei","tiktok ban","app ban","data center","cloud computing","edge computing","iot","smart city","smart grid","wearable","brain-computer","neuralink","科创","科技","人工智能","芯片","半导体","航天","航空","生物医药","新能源","量子","电池","稀土","技术封锁","技术制裁","产业链转移","脱钩","科技战","数字监管","大模型","机器人","自动驾驶","电动车","新能源车","火箭","空间站","量子计算","超导","基因编辑","疫苗研发","核聚变","自动驾驶","智慧城市","数据中心","云计算","物联网","脑机接口","深科技"]},
    ...
    {"id":"security",        "name":"治安",    "icon":"🛡️","color":"#4e342e",
     "keywords":["crime","terrorism","terrorist","extremist","jihadist","isis","al-qaeda","boko haram","al-shabaab","drug","drug cartel","narco","trafficking","human trafficking","arms trafficking","gang","mafia","organized crime","police","law enforcement","smuggling","smuggling ring","piracy","somali pirate","cybercrime","cyber attack","hacker","ransomware","data breach","assassination","coup","coup d'etat","prison","interpol","extradition","international court","icc","icj","tribunal","counter-terrorism","anti-terror","joint operation","murder","homicide","shoot","shooting","gun","gun violence","mass shooting","bomb","bombing","blast","explosive","robbery","heist","fraud","scam","corruption","embezzlement","bribery","money laundering","white-collar crime","illegal","illicit","contraband","weapon","firearm","arrest","detain","trial","convict","sentence","sentence to death","death penalty","capital punishment","prison escape","riot","prison riot","vigilante","lynch","mob","vigilante justice","paramilitary","warlord","militia","private military","mercenary","kidnap","kidnapping","abduction","hostage","ransom","extortion","blackmail","threat","intimidate","violent","violence","brutality","police brutality","torture","abuse","surveillance","wiretap","espionage","spy","intelligence","spyware","malware","phishing","identity theft","fraud ring","scam network","dark web","crypto crime","drug lord","cartel","fentanyl","opioid","overdose","meth","cocaine","heroin","weed legalization","gun control","gun law","armed robbery","car bomb","suicide bomb","drone strike","targeted killing","cross-border crime","transnational crime","wanted","fugitive","refugee camp attack","school shooting","stab","stabbing","arson","vandalism","looting","hooligan","治安","犯罪","恐怖主义","极端组织","伊斯兰国","基地组织","贩毒","毒品集团","跨国犯罪","人口贩卖","军火走私","帮派","黑手党","有组织犯罪","警察","走私","海盗","网络犯罪","黑客攻击","勒索软件","暗杀","政变","监狱","国际刑警","引渡","国际法庭","国际刑事法院","反恐","联合反恐","枪击","枪案","爆炸","抢劫","诈骗","贪污","腐败","洗钱","绑架","勒索","谋杀","死刑","暴力","警暴","酷刑","间谍","窃听","监控","暗网","毒品","芬太尼","鸦片","大麻合法","枪支管控","无人机袭击","跨国犯罪","校园枪击","纵火","打砸","暴徒","民兵","军阀","雇佣兵","私军"]},
